...
if (localStorage.getItem('pass') == "webdesign") {
  ...
  $("#changedays").append('	<p><input type="checkbox" id="dc1" name="dc" value="wakeup"> Did I go to bed early?</p><br><p><input type="checkbox" id="dc2" name="dc" value="Daily challenge 2"> Did I wake up early?</p> <br><p><input type="checkbox" id="dc3" name="dc" value="Daily challenge 3"> Did I eat healthy?</p> <br><p><input type="checkbox" id="dc4" name="dc" value="Daily challenge 3"> Did I work out?</p><button id="sbmt"> Submit</button>');
